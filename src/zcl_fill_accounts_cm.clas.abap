CLASS zcl_fill_accounts_cm DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_fill_accounts_cm IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA: lt_accounts type table of ZACCOUNTS_CM.
        ...
        DELETE FROM ZACCOUNTS_CM.

        INSERT ZACCOUNTS_CM from table @lt_accounts.
